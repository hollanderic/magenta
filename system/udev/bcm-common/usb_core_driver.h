...
struct usb_xfer_request
{
     ...
     * ::mx_status_t error code if the transfer failed.  ::USB_STATUS_SUCCESS
...
struct usb_device_driver
{
     ...
     * ::mx_status_t error code must be returned.  If necessary, device drivers
     ...
     */
    mx_status_t (*bind_device)(struct usb_device *dev);
