...
enum usb_port_feature {
    DWC_USB_PORT_CONNECTION     = 0,
    DWC_USB_PORT_ENABLE         = 1,
    DWC_USB_PORT_SUSPEND        = 2,
    DWC_USB_PORT_OVER_CURRENT   = 3,
    DWC_USB_PORT_RESET          = 4,
    DWC_USB_PORT_POWER          = 8,
    DWC_USB_PORT_LOW_SPEED      = 9,
    DWC_USB_C_PORT_CONNECTION   = 16,
    DWC_USB_C_PORT_ENABLE       = 17,
    DWC_USB_C_PORT_SUSPEND      = 18,
    DWC_USB_C_PORT_OVER_CURRENT = 19,
    DWC_USB_C_PORT_RESET        = 20,
    DWC_USB_PORT_TEST           = 21,
    DWC_USB_PORT_INDICATOR      = 22,
};
