...
public:
    static fbl::RefPtr<PinnedBuffer> Create(size_t size, zx::bti bti,
                                            uint32_t cache_policy);
    zx_status_t LookupPhys(size_t offset, zx_paddr_t* out);
...
private:
    explicit PinnedBuffer(zx::bti bti) : bti_(fbl::move(bti)) {}
    zx::bti bti_;

    fbl::VmoMapper vmo_mapper_;
    zx::vmo vmo_;
    zx::pmt pmt_;
