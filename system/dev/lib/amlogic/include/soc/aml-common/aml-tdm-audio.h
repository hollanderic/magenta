...
public:
    ...
    */
    ...
    uint32_t GetFifoDepth() const { return fifo_depth_;};
...
private:
    ...
    zx_off_t GetFrddrOffset(zx_off_t off) {
        ...
        case FRDDR_B:
            return EE_AUDIO_FRDDR_B_CTRL0 + off;
        case FRDDR_C:
            return EE_AUDIO_FRDDR_C_CTRL0 + off;
        }
        return EE_AUDIO_FRDDR_A_CTRL0 + off;
    }
    ...
    zx_off_t GetTdmOffset(zx_off_t off) {
        ...
        case TDM_OUT_B:
            return EE_AUDIO_TDMOUT_B_CTRL0 + off;
        case TDM_OUT_C:
            return EE_AUDIO_TDMOUT_C_CTRL0 + off;
        }
        return EE_AUDIO_TDMOUT_A_CTRL0 + off;
    }
