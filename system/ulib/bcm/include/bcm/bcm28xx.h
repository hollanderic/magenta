...
#define IC0_BASE                (BCM_PERIPH_BASE_PHYS + 0x2000)
#define ST_BASE                 (BCM_PERIPH_BASE_PHYS + 0x3000)
#define MPHI_BASE               (BCM_PERIPH_BASE_PHYS + 0x6000)
...
#define MMCI0_BASE              (BCM_PERIPH_BASE_PHYS + 0x202000)
#define I2S_BASE                (BCM_PERIPH_BASE_PHYS + 0x203000)
#define SPI0_BASE               (BCM_PERIPH_BASE_PHYS + 0x204000)
#define BSC0_BASE               (BCM_PERIPH_BASE_PHYS + 0x205000)
#define AUX_BASE                (BCM_PERIPH_BASE_PHYS + 0x215000)
#define MINIUART_BASE           (BCM_PERIPH_BASE_PHYS + 0x215040)
#define EMMC_BASE               (BCM_PERIPH_BASE_PHYS + 0x300000)
#define SMI_BASE                (BCM_PERIPH_BASE_PHYS + 0x600000)
#define BSC1_BASE               (BCM_PERIPH_BASE_PHYS + 0x804000)
#define USB_BASE                (BCM_PERIPH_BASE_PHYS + 0x980000)
#define MCORE_BASE              (BCM_PERIPH_BASE_PHYS + 0x0000)
