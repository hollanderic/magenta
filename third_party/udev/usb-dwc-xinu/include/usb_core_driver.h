...
// #include <semaphore.h>
// #include <thread.h>
#include <platform/usb_std_defs.h>
#include <stdbool.h>
// #include <usb_util.h>
...
struct usb_xfer_request
{
     ...
     * ::status_t error code if the transfer failed.  ::USB_STATUS_SUCCESS
...
struct usb_device_driver
{
     ...
     * ::status_t error code must be returned.  If necessary, device drivers
     ...
     */
    status_t (*bind_device)(struct usb_device *dev);
